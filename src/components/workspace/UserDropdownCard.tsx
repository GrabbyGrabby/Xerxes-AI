  ...
  return (
    <div className="relative font-sans">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-full border border-[#1F110E]/15 bg-[#ccfbf1] hover:bg-[#ccfbf1]/90 transition-all text-xs text-[#1F110E] shadow-[0_2px_8px_rgba(0,0,0,0.04)] cursor-pointer select-none font-bold"
      >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-3 w-64 bg-[#1F110E] border border-[#4A2F29] rounded-[24px] p-4.5 z-50 text-sm shadow-[0_16px_48px_rgba(0,0,0,0.12)] overflow-hidden text-white"
            >
              <div className="space-y-3.5">
                ...
                {/* Divider */}
                <div className="border-t border-[#4A2F29]" />
